	...
	$("#contenido1").on("click","#generar",function(){
		...
		var trimestre=$("#trimestre").val();
		 $.get("generar.php",{'Cabecera':cabeceralista,'CodCurso':CodCurso,'Separador':separador,"SeparadorFila":separadorfila,"Numeracion":numeracion,"Materias":materias,"Trimestre":trimestre},function(data){
			 var contenido="<a href='generar.php?"+'Cabecera='+cabeceralista+'&CodCurso='+CodCurso+'&Separador='+separador+"&SeparadorFila="+separadorfila+"&Numeracion="+numeracion+"&Materias="+materias+"&Trimestre="+trimestre+"' class='botonSec'>Descargar Archivo</a><hr>"+data;

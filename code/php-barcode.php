 ...
 */
//$genbarcode_loc="c:\genbarcode.exe";
//$genbarcode_loc="/usr/local/bin/genbarcode";
$genbarcode_loc=str_replace("/","\\", $_SERVER['DOCUMENT_ROOT']).DIRECTORY_SEPARATOR.$directory.DIRECTORY_SEPARATOR."code".DIRECTORY_SEPARATOR."genbarcode.exe";

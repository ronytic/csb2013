...
if(!empty($_POST)){
	...
	$rude->actualizarAlumno($values,$CodAlumno);
	$alumno->actualizarAlumno($valuesAlumno,$CodAlumno);
	...
	/*FIN DOCUMENTOS*/
	header("Location:../../impresion/alumno/rude2012.php?CodAlumno={$_POST['CodAlumno']}");
}
?>
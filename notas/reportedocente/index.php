...
<script language="javascript" type="text/javascript" src="../../js/notas/verregistrodenotas.js"></script>
...
<div class="container_12" id="cuerpo">
	<div class="grid_2">
        ...
        <div class="cuerpo"><?php
                ...
                foreach($docmateriacurso->mostrarDocenteOrdenCurso($CodDocente) as $cur){
